...
VersionInfo::VersionInfo(const String & path, const String & current_version)
    : dir(path), data_path(dir + "upgrade.info"), write_version(current_version), read_versions({write_version}),
