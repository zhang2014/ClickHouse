...
ClusterProxy::QingCloudSelectStreamFactory::QingCloudSelectStreamFactory(
    ...
    const Tables & external_tables_, const String query_version_, UInt64 query_shard_number_)
...
ClusterProxy::QingCloudRemoteBlockInputStream::QingCloudRemoteBlockInputStream(
    const BlockInputStreamPtr & input, const String & version_, const UInt64 & shard_num_, Settings & settings_)
