...
static String writeVersionAndShardText(UInt64 version, UInt64 shard_number, String suffix)
{
...
void QingCloudAsynchronism::writeToShard(const UInt64 version, const UInt64 shard_number, const String &file_name)
{
...
void QingCloudAsynchronism::writeToReplica(const UInt64 version, const UInt64 shard_number,
...
QingCloudAsynchronism::ReplicasDirectoryInfo::ReplicasDirectoryInfo(const String &dir_name)
{
    ...
    current_writing_version = parse<UInt64>(address_begin, writing_version_end - address_begin);
