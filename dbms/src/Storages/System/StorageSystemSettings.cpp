...
#define ADD_SETTING(TYPE, NAME, DEFAULT, DESCRIPTION)      \
    ...
    res_columns[1]->insert(String(#TYPE));                 \
    res_columns[2]->insert(settings.NAME.toString());      \
    res_columns[3]->insert(UInt64(settings.NAME.changed)); \
    res_columns[4]->insert(String(DESCRIPTION));
