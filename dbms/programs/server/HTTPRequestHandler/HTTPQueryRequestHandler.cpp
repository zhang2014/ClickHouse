...
template <typename QueryParametersExtractor>
HTTPQueryRequestHandler<QueryParametersExtractor>::HTTPQueryRequestHandler(const IServer & server_, const QueryParametersExtractor & extractor_)
...
template <typename QueryParametersExtractor>
void HTTPQueryRequestHandler<QueryParametersExtractor>::processQuery(
